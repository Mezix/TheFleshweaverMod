...
public class VitalityPower extends AbstractPower{
    ...
    public static final String POWER_ID = TheFleshweaverMod.makeID("VitalityPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    private static final Texture texture128 = TextureLoader.getTexture(makePowerPath("Vitality_128.png"));
    private static final Texture texture48 = TextureLoader.getTexture(makePowerPath("Vitality_48.png"));
