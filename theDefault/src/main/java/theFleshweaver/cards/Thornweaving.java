...
public class Thornweaving extends AbstractDynamicCard {
    public static final String ID = TheFleshweaverMod.makeID(Thornweaving.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new ThornweavingPower(p, p, this.magicNumber)));
    }
    @Override
    public void upgrade() {
        if (!upgraded) {
